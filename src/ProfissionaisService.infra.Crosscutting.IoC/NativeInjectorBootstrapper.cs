...
public static class NativeInjectorBootstrapper
{
    ...
    private static void RegisterQueries(IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddScoped<IBuscarProfissionaisAdminQueryService, BuscarProfissionaisAdminQueryService>();
        serviceCollection
        ...
        serviceCollection
            .AddScoped<IBuscarWhatsappsPorProfissionalIdQueryService, BuscarWhatsappsPorProfissionalIdQueryService>();
    }
